...
public class ActionBar extends RelativeLayout implements OnClickListener {
	...
	public void addOverflowAction(Action action) {
		mActionsView.addView(inflateOverflowAction(action),
				mActionsView.getChildCount());
	}

	private View inflateOverflowAction(Action action) {
		View view = mInflater.inflate(R.layout.actionbar_overflow_item,
				mActionsView, false);
